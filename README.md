...
#### 重要通知
* <span style="color:red">本文档为3.x版文档,2.x文档请前往:<a href="https://esap.vip/2.8/">旧版文档</a></span>
...
##### 接口功能差异
由于微信限制，订阅号/服务号/小程序接口(/wxs/应用名)仅能做有限的查询，与通讯录相关的功能不可用。
而企业号/企业微信接口(/wx/应用名)可提供完整的功能。

**注意：公众号接口回调必须使用`安全加密模式`！**
